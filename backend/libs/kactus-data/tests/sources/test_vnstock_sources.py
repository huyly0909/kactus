...
class TestVnstockOHLCVSource:
    ...
    def test_sync_success(self):
        ...
        result = VnstockOHLCVSource(source="KBS", interval="1D").sync(
            date(2024, 1, 1), date(2024, 1, 31), "VCI"
        )
        assert result.success is True
...
class TestVnstockListingSource:
    ...
    def test_sync_success(self):
        ...
        result = VnstockListingSource(source="KBS").sync(
            date(2024, 1, 1), date(2024, 1, 1), "ALL"
        )
        assert result.success is True
