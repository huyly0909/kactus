...
async def test_build_runtime_without_a_scheduler(db, tmp_path, monkeypatch):
    ...
    from kactus_data_plane import app as app_mod
    from kactus_data_plane.app import build_runtime, shutdown_runtime
    from kactus_data_plane.config import Settings
